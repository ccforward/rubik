function dropdown (e, el, binding, bridge, hover) {
  e.preventDefault()
  ...
  bridge.pub(`dropdown:open:${binding.arg}`)
}
...
function directive (el, binding, v) {
  ...
  el.onclick = e => dropdown(e, el, binding, v.context.$rubik.bridge, false)
  el.onmouseenter = e => dropdown(e, el, binding, v.context.$rubik.bridge, true)
}
